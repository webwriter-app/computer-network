...
export class ImportExportController {
    ...
    static simulations: Map<string, ExampleDescription> = new Map<string, ExampleDescription>([
        ...
        ["Example 5", new ExampleDescription(5, "resources/preview-examples/accesspoint-simulation.png", "resources/examples/accesspoint-simulation.json", "Wifi network with 1 access point, 3 hosts.")],
